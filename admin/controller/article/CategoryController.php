...
use Dou\Admin\Request\Article\CategoryFormRequest;
use Dou\Admin\Service\Article\CategoryService;
...
class CategoryController extends BaseController
{
    ...
    {
        return $this->view('article_category.htm', [
            'ur_here' => lang('article_category'),
            'page_actions' => array(
                array('href' => route('admin.article.category.create'), 'text' => lang('article_category_create'), 'style' => 'add'),
            ),
            'rec' => 'default',
    ...
    {
        return $this->view('article_category.htm', [
            'ur_here' => lang('article_category_create'),
            'page_actions' => array(
                array('href' => route('admin.article.category'), 'text' => lang('article_category'), 'style' => ''),
            ),
            'rec' => 'create',
            'article_category' => ArticleCategory::flat(),
            'cat_info' => $this->categoryService->buildCategoryDefaultData(),
            'btn_lang' => language()->buildLangButtons('article_category', '', 'name, keywords, description'),
        ]);
    }
    ...
    public function store(CategoryFormRequest $formRequest, Request $request)
    {
        ...
        return redirect(route('admin.article.category.edit', array('id' => $newCatId)))
            ->with('success', lang('article_category_add_succes'), route('admin.article.category'), lang('back_to_list'));
    }
    ...
    public function edit(Request $request)
    {
        ...
        return $this->view('article_category.htm', [
            'ur_here' => lang('article_category_edit'),
            'page_actions' => array(
                array('href' => route('admin.article.category'), 'text' => lang('article_category'), 'style' => ''),
            ),
            'rec' => 'edit',
            'cat_info' => $catInfo,
            'article_category' => ArticleCategory::flat($catId),
            'btn_lang' => language()->buildLangButtons('article_category', $catId, 'name, keywords, description'),
        ]);
    }
    ...
    public function update(CategoryFormRequest $formRequest, Request $request)
    {
        ...
        return redirect(route('admin.article.category.edit', array('id' => (int) $data['category_id'])))
            ->with('success', lang('article_category_edit_succes'), route('admin.article.category'), lang('back_to_list'));
    }
