...
/**
 * {@see \Dou\Core\Web\Template\Ast\NodeType::CONTINUE_} 标签编译器：{continue} → continue;。
 */
class ContinueTagCompiler implements TagCompilerInterface
{
    /**
     * @inheritDoc
     */
