...
/**
 * {@see \Dou\Core\Web\Template\Ast\NodeType::PHP} 标签编译器：{php} 编译期拒绝
 * （与现网一致，不允许模板内嵌原生 PHP）。
 */
class PhpTagCompiler implements TagCompilerInterface
{
    /**
     * @inheritDoc
     */
    ...
    {
        $ctx->expr->syntaxError('php tags not permitted');
    }
}
