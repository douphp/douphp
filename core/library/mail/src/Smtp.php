    ...
    public function authenticate(
        ...
        switch ($authtype) {
            ...
            case 'NTLM':
                ...
                $temp = new stdClass;
                $ntlmClientClass = 'ntlm_sasl_client_class';
                if (!class_exists($ntlmClientClass, false)) {
                    $this->setError('NTLM SASL client class not found');
                    return false;
                }
                $ntlm_client = new $ntlmClientClass;
