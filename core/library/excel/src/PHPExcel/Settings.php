...
class PHPExcel_Settings
{
     ...
     */
    public static function setXmlLoaderOptions($options = null)
    {
     ...
     */
    public static function getXmlLoaderOptions()
    {
        if (is_null(self::$libXmlLoaderOptions) && defined('LIBXML_DTDLOAD')) {
            self::setXmlLoaderOptions(LIBXML_DTDLOAD | LIBXML_DTDATTR);
