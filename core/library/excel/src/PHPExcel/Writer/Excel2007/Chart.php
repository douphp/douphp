...
class PHPExcel_Writer_Excel2007_Chart extends PHPExcel_Writer_Excel2007_WriterPart
{
     ...
     * @throws  PHPExcel_Writer_Exception
     */
    private function writeTitle($title = null, $objWriter = null)
    {
        if (is_null($title)) {
            return;
        }
     ...
     * @throws  PHPExcel_Writer_Exception
     */
    private function writeLegend($legend = null, $objWriter = null)
    {
        if (is_null($legend)) {
            return;
        }
     ...
     * @throws  PHPExcel_Writer_Exception
     */
    private function writePlotArea(PHPExcel_Chart_PlotArea $plotArea, $xAxisLabel = null, $yAxisLabel = null, $objWriter = null, $pSheet = null, $xAxis = null, $yAxis = null, $majorGridlines = null, $minorGridlines = null)
    {
        if (is_null($plotArea)) {
            return;
        }
     ...
     * @throws  PHPExcel_Writer_Exception
     */
    private function writeLayout($layout = null, $objWriter = null)
    {
